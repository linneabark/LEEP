...
public class ShowQuotesPopUp {
    ...
    public void showQuotesPopUp(final Context context, Activity activity, final String buttonTag) {
        ...
        Button saveButtonQuotes = (Button) quotesLayout.findViewById(R.id.save_button_quotes);
        ...
        Button exitButtonQuotes = (Button) quotesLayout.findViewById(R.id.close_button_quotes);
